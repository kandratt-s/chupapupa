...
# -----------------------------
ROUTES = {
    "auth": "services.web.local_web.views.auth",
    "student_events": "services.web.local_web.views.student_events",
    "student_applications": "services.web.local_web.views.student_applications",
    "student_profile": "services.web.local_web.views.student_profile",
    "admin_events_create": "services.web.local_web.views.admin_events_create",
    "admin_events_list": "services.web.local_web.views.admin_events_list",
    "admin_applications": "services.web.local_web.views.admin_applications",
    "admin_users_create": "services.web.local_web.views.admin_users_create",
    "admin_users_list": "services.web.local_web.views.admin_users_list",
    "admin_profile": "services.web.local_web.views.admin_profile",
    "admin_statistics": "services.web.local_web.views.admin_statistics",
}

module_name = ROUTES.get(session["route"], "services.web.local_web.views.auth")
